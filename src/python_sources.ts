...
export const PYTHON_FILES: PythonFileSpec[] = [
  {
    filename: 'main.py',
    description: 'PyQt6/PySide6 Main GUI window, sidebar navigation, form and split explorer',
...
`
  },
  {
    ...
    description: 'SQLite database connection, schema setup, CRUD queries, and ./dsa_assets/ manager',
    code: `"""
...
def save_local_asset(source_file_path: str, assets_dir: str = DEFAULT_ASSETS_DIR) -> Optional[str]:
    ...
    Returns the relative path to be stored in the database, e.g., 'dsa_assets/asset_xxxx.png'.
    """
...
`
  },
  {
    ...
    description: 'Custom QSyntaxHighlighter for code blocks (PyQt6 / PySide6)',
    code: `"""
...
class DSACodeHighlighter(QSyntaxHighlighter):
    def __init__(self, parent=None):
        ...
        type_color = QColor("#e5c07b")
        builtin_color = QColor("#61afef")
        string_color = QColor("#98c379")
        comment_color = QColor("#5c6370")
        number_color = QColor("#d19a66")
        ...
        types = [r"\\bint\\b", r"\\bfloat\\b", r"\\bstr\\b", r"\\bbool\\b", r"\\blist\\b", r"\\bdict\\b", r"\\bNone\\b", r"\\bTrue\\b", r"\\bFalse\\b", r"\\bself\\b"]
        ...
        builtins = [r"\\blen\\b", r"\\brange\\b", r"\\benumerate\\b", r"\\bprint\\b", r"\\bmin\\b", r"\\bmax\\b", r"\\bsum\\b"]
...
`
  ...
  {
    filename: 'theme.py',
    description: 'QSS Dark Mode stylesheet for sleek desktop styling',
    code: `"""Modern Dark Mode Theme for PyQt6 / PySide6."""
...
#sidebarWidget { background-color: #17181c; border-right: 1px solid #272a31; }
QPushButton.nav-btn {
...
QPushButton.nav-btn:hover { background-color: #212329; color: #f3f4f6; }
QPushButton.nav-btn:checked { background-color: #2d3039; color: #ffffff; border-left: 3px solid #6366f1; }
...
QPushButton.secondary-btn:hover { background-color: #2a2d36; }
QLineEdit, QTextEdit {
...
QTextEdit#codeEditor, QTextEdit#readOnlyCodeViewer {
...
QListWidget { background-color: #141519; border: none; }
QListWidget::item { background-color: #18191f; border: 1px solid #272a33; border-radius: 8px; margin: 4px 6px; padding: 10px; }
QListWidget::item:hover { background-color: #1f2129; border-color: #3b3f4d; }
QListWidget::item:selected { background-color: #252833; border: 1px solid #6366f1; }
"""
`
  },
  {
    ...
    code: `PyQt6>=6.5.0
# Or uncomment below for PySide6:
# PySide6>=6.5.0
`
  },
  {
    filename: 'run_app.sh',
    description: 'One-click run script for Linux and macOS',
